        ...
        <div className='flex justify-evenly place-items-center h-[100vh] m-auto md:flex-col lg:flex-row'>
            ...
            <div className='min-[280px]:w-full lg:w-[35%] flex flex-col justify-center place-items-center'>
                <div className='min-[280px]:w-[80%]'>
                    ...
                    <input className='text-xs h-[35px] w-full pl-3 rounded-md outline outline-1 outline-black mb-4' type="text" placeholder='Enter your New Password' />
                    <label className=''>Confirm Password</label>
                    <input className='text-xs h-[35px] w-full pl-3 rounded-md outline outline-1 outline-black mb-4' type="text" placeholder='Re-write your New Password' />
                    ...
                    <input className='text-xs h-[35px] w-full pl-3 rounded-md outline outline-1 outline-black mb-4' type="text" placeholder={placeholder} />
                    <label className=''>OTP</label>
                    <input className='text-xs h-[35px] w-full pl-3 rounded-md outline outline-1 outline-black mb-4' type="text" placeholder='Enter your OTP' />

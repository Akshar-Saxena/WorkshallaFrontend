    ...
    <>
      ...
      <div className="flex items-center justify-between bg-purple-500/25 p-2 rounded-lg ml-4 mr-4 min-[280px]:flex-col md:flex-row">
        ...
        <div className="flex items-center min-[280px]:flex-col md:flex-row">
          ...
          />
          <div className="pl-4">
            <h1 className="text-lg font-semibold">{document.cookie.split(';')[0].split("=")[1]}</h1>
      ...
      <div className="mt-16 ml-4 mr-4 outline outline-purple-500 outline-1 rounded-lg">
        ...
        <p className="w-[90%] text-justify m-auto pb-6 text-xs">Lorem ipsum, placeholder or dummy text used in typesetting and graphic design for previewing layouts. It features scrambled Latin text, which emphasizes the design over content of the layout. It is the standard placeholder text of the printing and publishing industries.<br />

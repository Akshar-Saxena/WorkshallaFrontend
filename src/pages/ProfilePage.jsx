...
export default function ProfilePage()
{
    return(
        <>
        <NavBar />
        <div className="flex items-center justify-between bg-purple-500/25 p-2 rounded-lg ml-4 mr-4">

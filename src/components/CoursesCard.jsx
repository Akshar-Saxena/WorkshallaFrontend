...
export default function CoursesCard()
{
    return(
       ...
       <div className="w-[367px] h-[408px] my-10 mx-10 rounded-lg shadow-xl">
         <img src="../src/assets/rectangleImage.png" alt="" className=" w-[366px] h-[186px] rounded-lg" />
         <h2 className="ml-8 mt-2 font-bold">Wordpress for Beginners - Master Wordpress</h2>
         <div className="flex">
         <img src="../src/assets/patternEllipse.png" alt="" className="ml-8" />  
         <p>Aman Kumar<br/>IITian from BHU, 3year of experience</p>
        </div>
        ...
        <div className="w-[367px] h-[408px] my-10 mx-10 rounded-lg shadow-xl">
         ...
         <p>Aman Kumar<br/>IITian from BHU, 3year of experience</p>
          ...
          <hr className='h-[1px] bg-gray-600 mt-12 mb-4' /> 
          <div className="flex ml-8 ">
           <h2 className="text-red-500 font-bold">$30</h2>
            <div className="flex ml-28">
              <img src="../src/assets/starImage.png" alt="" className="" />
              <h6 className="">3 star</h6>
            </div>  
